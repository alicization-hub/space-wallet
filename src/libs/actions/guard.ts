...
import type { Wallet } from '@/libs/drizzle/types'
...
type AuthedAction<T extends unknown[], R> = (wallet: Wallet, ...args: T) => Promise<R>

export function withAuth<T extends unknown[], R>(action: AuthedAction<T, R>) {
