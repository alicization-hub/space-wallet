 ...
 *
 * @param  qb - The `qb` parameter is a query builder object that is used to construct SQL queries for selecting data from a database table.
 ...
 * @param page - The `page` parameter represents the page number of the paginated results.
 * It defaults to 1 if not provided.
 * @param pageSize - The `pageSize` parameter specifies the number of items to be displayed on each page of the paginated results.
