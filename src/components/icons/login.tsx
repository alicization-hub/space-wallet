...
export function LoginIcon(props: React.SVGAttributes<SVGElement>) {
  return (
    <Svg {...props}>
      <path d='M15.8125 12.0217H3.77148' strokeWidth={1.5} strokeLinecap='round' strokeLinejoin='round' />
      <path
